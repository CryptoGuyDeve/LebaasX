        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-sm">
              LebaasX is a fashion-forward clothing brand offering stylish and
              comfortable t-shirts and trousers for young trendsetters. Elevate
              your wardrobe with our high-quality, affordable apparel.
            </p>
            <SocialMedia
