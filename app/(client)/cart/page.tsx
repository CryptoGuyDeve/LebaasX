...
import paypalLogo from "@/images/jazzcashlogo.png";
import {
                ...
                <div className="lg:col-span-1">
                  <div className="hidden md:inline-block w-full bg-white p-6 rounded-lg border">
                    ...
                    <div className="space-y-4">
                      ...
                      <Link
                        href={"/"}
                        className="flex items-center justify-center py-1 border border-darkColor/50 rounded-full hover:border-darkColor hover:bg-darkColor/5 hoverEffect"
                      >
                        <Image
                          src={paypalLogo}
                          alt="paypalLogo"
